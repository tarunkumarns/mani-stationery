...
export function Hero3D({ onOpenEnquiry, onOpenDownloadPriceList }: Hero3DProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 left-10 w-96 h-96 bg-orange-200/30 dark:bg-orange-950/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left flex flex-col items-start">
            ...
            {/* Main Headline */}
            <h1 className="font-heading font-black text-4xl sm:text-6xl text-slate-900 dark:text-white tracking-tight leading-[1.1] mb-5">
              Small things. <br />
              <span className="text-indigo-600 drop-shadow-xs">
                Big ideas.
              </span>
            </h1>

            {/* Subtitle */}
            <p className="text-slate-700 dark:text-amber-100/80 text-base sm:text-lg leading-relaxed max-w-2xl mb-6 font-normal">
            ...
            <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
              ...
              <a
                ...
                className="btn-primary flex-1 sm:flex-none px-6 py-3.5 rounded-2xl text-sm font-black flex items-center justify-center gap-2 shadow-md shadow-orange-950/10"
              >
              ...
              <button
                ...
                className="btn-primary-whatsapp flex-1 sm:flex-none px-6 py-3.5 rounded-2xl text-sm font-black flex items-center justify-center gap-2 shadow-md shadow-emerald-950/10 cursor-pointer"
              >
              ...
              <button
                ...
                className="btn-primary-gold w-full sm:w-auto px-5 py-3.5 rounded-2xl text-sm font-black flex items-center justify-center gap-2 shadow-md shadow-amber-900/10 cursor-pointer"
              >
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3 text-xs text-slate-600 dark:text-amber-200/80 font-medium">
              <span className="flex items-center gap-1.5 bg-white dark:bg-slate-800 px-3 py-1 rounded-lg border border-slate-200 dark:border-slate-800">
                <MapPin className="w-3.5 h-3.5 text-indigo-600" />
                <span>{STORE_INFO.address.landmark}, Andippatti</span>
              </span>
              <span className="flex items-center gap-1 bg-amber-50 dark:bg-amber-950/60 px-2.5 py-1 rounded-lg border border-amber-200 dark:border-amber-800/60 text-amber-900 dark:text-amber-200 font-bold">
          ...
          <div className="lg:col-span-5 flex justify-center w-full">
            <div className="w-full max-w-md rounded-3xl bg-white dark:bg-slate-800 border-2 border-amber-900/15 dark:border-slate-800 p-6 sm:p-7 shadow-xl relative overflow-hidden transition-colors">
              ...
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4 mb-5">
                ...
                <span className="text-[11px] font-bold text-slate-500 dark:text-amber-300 uppercase tracking-wider bg-slate-100 dark:bg-[#2f1a0f] px-2.5 py-1 rounded-full">
                  Andippatti
                </span>
              </div>
